...
{
  [ShowOnlyToAdmin]
  public class A_CardsCmd : ICommand
  {
    ...
    private const string Card = "/cards ";
    ...
    public async Task Do(ITurnContext<IMessageActivity> turnContext)
    {
      ...
      await turnContext.SendActivityAsync(MessageFactory.Attachment(activity.Attachments, activity.Text));
    }

    public A_CardsCmd()
    {
      CommandsName = new List<string>() { Card.Replace(" ", "") };
      Description = "Show cards type";
    }
    ...
    private static Attachment GetDefaultCard()
    {
      var heroCard = new HeroCard
      {
        ...
        Buttons = new List<CardAction>
                {
                    new CardAction(ActionTypes.ImBack, "HeroCard", value: Card+HeroCard),
                    new CardAction(ActionTypes.ImBack, "Thumbnail", value: Card+ThumbnailCard),
                    new CardAction(ActionTypes.ImBack, "Receipt", value: Card+ReceiptCard),
                    new CardAction(ActionTypes.ImBack, "Signin", value: Card+SigninCard),
                    new CardAction(ActionTypes.ImBack, "Animation", value: Card+AnimationCard),
                    new CardAction(ActionTypes.ImBack, "Video", value: Card+VideoCard),
                    new CardAction(ActionTypes.ImBack, "Audio", value: Card+AudioCard),
                }
      };
